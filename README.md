...
Descrição: projeto para criação de pedidos(MarketPlace).
...
Passo 2: acesse o repositório order-service
...
product-service = https://github.com/felixguh/product-service
